...
# --- DOCKERFILE VERSION: TGW-v34-SIMPLIFIED-DEBUG ---
...
# --- 4. Clone Main Repo (NO custom extensions for this test) ---
WORKDIR /app
...
# --- 7. Create CMD_FLAGS.txt with llama.cpp server arguments ---
# This is the most important change. We are now targeting the backend server directly.
RUN echo "--host 0.0.0.0 --port 7860" > /app/CMD_FLAGS.txt
